...
type
  ...
  public
    ...
    function Inserir:Boolean;//(cds:TClientDataSet):Integer;
    function Atualizar:Boolean;//(cds:TClientDataSet):Boolean;
...
begin
  ...
  try
    ...
    Qry.ParamByName('vendasId').AsInteger :=VendaId;
    Try
      Qry.ExecSQL;
...
begin
  try
    ...
    Qry.SQL.Add('UPDATE vendas '+
                ...
                ' WHERE vendasId=:vendasId ');
    Qry.ParamByName('vendasId').AsInteger    :=Self.F_vendaId;
...
begin
  try
    ...
    Qry.SQL.Add('SELECT vendasId '+
                ...
                '  FROM vendas '+
                ' WHERE vendasId=:vendasId');
    Qry.ParamByName('vendasId').AsInteger:=id;
    Try
      Qry.Open;

      Self.F_vendaId    := Qry.FieldByName('vendasId').AsInteger;
